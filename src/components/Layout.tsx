  ...
  <Wrapper>
    <Helmet>
      ...
      <meta
        ...
        content={`(Disclaimer: Whether or not Thomas is actually dead is a quantum unknowability, a sort of "Schrodinger's Cat" sitation, if you will. How to know if Thomas is actually dead? How do we know that anything is true at all? I'm afraid I can't help you!)`}
      />
